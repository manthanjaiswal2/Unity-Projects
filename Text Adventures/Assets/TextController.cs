...
public class TextController : MonoBehaviour {
	...
	private enum States {
			...
			stairs_1, stairs_2, courtyard, floor, corridor_1, corridor_2, corridor_3, closet_door,
			in_closet
			};
	...
	void sheets_1 () {
		text.text = "Holding a mirror in your hand doen't make the sheets look" +
					"any better. \n\n" +
					"Press R to Return to roaming your cell";
		if(Input.GetKeyDown(KeyCode.R)) {
			myState = States.cell;
	...
	void corridor_0 () {
		text.text = "You're out of cell, but not out of trouble." +
